...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("¿Crear nuevo polígono? (S/N) ");
			seguir = teclado.next();
	...
	private static void mostrarMenu() {
		System.out.println("");
		System.out.println("Este programa crea un polígono con los datos introducidos por el usuario y calcula el perímetro.");
		System.out.println("Selecciona los datos de los que dispones:");
		System.out.println("1. Número de lados y Altura.");
		System.out.println("2. Número de lados y Longitud de un lado.");
	}
